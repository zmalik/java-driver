...
/**
 * Similar to a {@link RingDiagnostic}, but the {@linkplain TokenRange token range} availability
 * checks are performed on a single {@linkplain #getDatacenter() datacenter} only.
 *

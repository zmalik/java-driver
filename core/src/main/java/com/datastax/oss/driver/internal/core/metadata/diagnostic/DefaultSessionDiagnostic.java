...
public class DefaultSessionDiagnostic implements SessionDiagnostic {
  ...
  public DefaultSessionDiagnostic(
      @NonNull TopologyDiagnostic topologyDiagnostic, @Nullable RingDiagnostic ringDiagnostic) {
  ...
  public Optional<RingDiagnostic> getRingDiagnostic() {
    return Optional.ofNullable(ringDiagnostic);
  }
}
